...
const Footer: React.FC<FooterProps> = ({ isMinimal = false }) => {
    ...
    return (
        <footer className="bg-brand-100 text-brand-500 py-3 mt-auto text-[10px] text-center border-t border-brand-200">
            <div className="flex flex-col md:flex-row justify-center items-center gap-2 md:gap-4">
                ...
                {!isMinimal && (
                    <Link to="/references" className="hover:text-brand-900 transition-colors underline decoration-dotted underline-offset-2">
